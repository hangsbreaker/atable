...
function atable_init(){
	...
	.atable .datainfo{
		...
		right:0px;margin-top: 23px;margin-left: 5px;position:relative;
	}
	.atable .warningdb{
		position:absolute;
		width:100%;
